...
/**
 * check_chain - Checks whether command chaining should continue.
 * @info: The parameter struct.
 * @buf: The character buffer to analyze.
 * @p: Address of the current position in the buffer.
...
/**
 * replace_string - Replaces a string in the tokenized string.
 * @old: The parameter struct.
 * @new: The string to replace the old string.
 * Return: 1 if an alias is replaced, 0 otherwise.
 */
