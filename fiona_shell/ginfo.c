 ...
 * @info: The address of the info_t struct to be cleareed.
 * This function sets all fields of the info_t struct to NULL or 0.
 */
...
/**
 * set_info -Initializes the info_t struct with argument vector.
